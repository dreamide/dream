...
export const AUTO_COMPACT_TRIGGER_RATIO = 0.55;
const AUTO_COMPACT_TARGET_RATIO = 0.35;
const MIN_MESSAGES_TO_COMPACT = 4;
const MIN_RECENT_MESSAGES_TO_KEEP = 2;
const DEFAULT_RECENT_MESSAGES_TO_KEEP = 4;
