export const supplementalMessages = {
  de: {
    ...
    savedPrompts: {
      title: "Prompts",
      description:
        "Gespeicherte Prompts, die du im Chat eines beliebigen Projekts ausführen kannst.",
      newPrompt: "Neuer Prompt",
      editPrompt: "Prompt bearbeiten",
      nameLabel: "Name",
      namePlaceholder: "z. B. Review-Kommentare umsetzen",
      promptLabel: "Prompt",
      promptPlaceholder:
  ...
  en: {
    ...
    savedPrompts: {
      title: "Prompts",
      description: "Saved prompts you can run in any project's chat.",
      newPrompt: "New prompt",
      editPrompt: "Edit prompt",
      nameLabel: "Name",
      namePlaceholder: "e.g. Address review comments",
      promptLabel: "Prompt",
      promptPlaceholder:
    ...
    projects: {
      ...
      iconUpload: "Project icon",
      changeIcon: "Change icon",
      resetIcon: "Reset",
      iconUploadHint:
        "Upload an image (up to 5 MB). Without a custom icon, the project is scanned automatically.",
      iconSaveFailed:
        "Could not load the icon. Choose a valid image file up to 5 MB.",
  ...
  es: {
    ...
    savedPrompts: {
      title: "Prompts",
      description:
        "Prompts guardados que puedes ejecutar en el chat de cualquier proyecto.",
      newPrompt: "Nuevo prompt",
      editPrompt: "Editar prompt",
      nameLabel: "Nombre",
      namePlaceholder: "p. ej., Atender los comentarios de la revisión",
      promptLabel: "Prompt",
      promptPlaceholder:
      ...
      emptyShort: "Aún no hay prompts",
      managePrompts: "Administrar prompts…",
    },
    checkpoints: {
  ...
  fr: {
    ...
    savedPrompts: {
      title: "Prompts",
      description:
        "Des prompts enregistrés que vous pouvez exécuter dans le chat de n'importe quel projet.",
      newPrompt: "Nouveau prompt",
      editPrompt: "Modifier le prompt",
      nameLabel: "Nom",
      namePlaceholder: "p. ex. Traiter les commentaires de revue",
      promptLabel: "Prompt",
      promptPlaceholder:
      ...
      emptyShort: "Aucun prompt pour l'instant",
  ...
  it: {
    ...
    savedPrompts: {
      title: "Prompt",
      description:
        "Prompt salvati che puoi eseguire nella chat di qualsiasi progetto.",
      newPrompt: "Nuovo prompt",
      editPrompt: "Modifica prompt",
      nameLabel: "Nome",
      namePlaceholder: "ad es. Gestire i commenti della revisione",
      promptLabel: "Prompt",
      promptPlaceholder:
      ...
      emptyShort: "Ancora nessun prompt",
    ...
    projects: {
      ...
      iconSaveFailed: "Scegli un’immagine valida fino a 5 MB.",
  ...
  ja: {
    ...
    savedPrompts: {
      title: "プロンプト",
      description:
        "どのプロジェクトのチャットでも実行できる保存済みプロンプトです。",
      newPrompt: "新しいプロンプト",
      editPrompt: "プロンプトを編集",
      nameLabel: "名前",
      namePlaceholder: "例: レビューコメントに対応する",
      promptLabel: "プロンプト",
      promptPlaceholder:
    ...
    projects: {
      ...
      iconUpload: "プロジェクトアイコン",
      changeIcon: "アイコンを変更",
      resetIcon: "リセット",
      iconUploadHint:
        "画像をアップロード（最大5 MB）。未設定の場合は自動検索します。",
      iconSaveFailed: "5 MB以下の有効な画像を選択してください。",
      removeIcon: "アイコンを削除",
  ...
  ko: {
    ...
    savedPrompts: {
      title: "프롬프트",
      description:
        "어느 프로젝트의 채팅에서든 실행할 수 있는 저장된 프롬프트입니다.",
      newPrompt: "새 프롬프트",
      editPrompt: "프롬프트 편집",
      nameLabel: "이름",
      namePlaceholder: "예: 리뷰 코멘트 반영",
      promptLabel: "프롬프트",
      promptPlaceholder:
    ...
    projects: {
      ...
      iconSaveFailed: "5 MB 이하의 올바른 이미지를 선택하세요.",
      removeIcon: "아이콘 제거",
  ...
  pt: {
    ...
    savedPrompts: {
      title: "Prompts",
      description:
        "Prompts salvos que você pode executar no chat de qualquer projeto.",
      newPrompt: "Novo prompt",
      editPrompt: "Editar prompt",
      nameLabel: "Nome",
      namePlaceholder: "ex.: Resolver os comentários da revisão",
      promptLabel: "Prompt",
      promptPlaceholder:
      ...
      emptyShort: "Ainda não há prompts",
  ...
  vi: {
    ...
    savedPrompts: {
      title: "Prompt",
      description:
        "Các prompt đã lưu mà bạn có thể chạy trong trò chuyện của bất kỳ dự án nào.",
      newPrompt: "Prompt mới",
      editPrompt: "Sửa prompt",
      nameLabel: "Tên",
      namePlaceholder: "vd: Xử lý nhận xét review",
      promptLabel: "Prompt",
      promptPlaceholder:
  ...
  "zh-Hans": {
    ...
    savedPrompts: {
      title: "提示词",
      description: "已保存的提示词，可在任意项目的聊天中运行。",
      newPrompt: "新建提示词",
      editPrompt: "编辑提示词",
      nameLabel: "名称",
      namePlaceholder: "例如：处理评审意见",
      promptLabel: "提示词",
    ...
    projects: {
      ...
      changeIcon: "更改图标",
      resetIcon: "重置",
      iconUploadHint: "上传图片（最大 5 MB）。未设置自定义图标时自动扫描。",
      iconSaveFailed: "请选择不超过 5 MB 的有效图片。",
      removeIcon: "移除图标",
  ...
  "zh-Hant": {
    ...
    savedPrompts: {
      title: "提示詞",
      description: "已儲存的提示詞，可在任何專案的聊天中執行。",
      newPrompt: "新提示詞",
      editPrompt: "編輯提示詞",
      nameLabel: "名稱",
      namePlaceholder: "例如：處理審查意見",
      promptLabel: "提示詞",
    ...
    projects: {
      ...
      changeIcon: "變更圖示",
      resetIcon: "重設",
      iconUploadHint: "上傳圖片（最大 5 MB）。未設定自訂圖示時自動掃描。",
      iconSaveFailed: "請選擇不超過 5 MB 的有效圖片。",
      removeIcon: "移除圖示",
